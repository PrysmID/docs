...
```json
{
  "iss": "https://acme.auth.prysmid.com",
...
- **`iss`**: el issuer. Debe ser exactamente `https://<slug>.auth.prysmid.com`. Si validás contra otro string, vas a aceptar tokens forjados.
...
```
GET https://acme.auth.prysmid.com/oidc/v1/end_session
