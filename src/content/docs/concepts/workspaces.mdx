---
title: Workspaces
description: La unidad básica del modelo. Un workspace = una cuenta tuya = una instancia dedicada.
---
...
- Un **dominio de auth** (`acme.auth.prysmid.com`).
...
|---|---|
| `provisioning` | Acabamos de crear el workspace. Estamos levantando la instancia dedicada, configurando DNS, dejando todo listo. Toma 60-90 s. |
...
| `failed_provisioning` | Algo falló al crear. Recoverable sin perder el slug; escribinos. |
...
<Aside type="note">
Los miembros del workspace son **cuentas humanas en `app.prysmid.com`**, no usuarios finales. Los usuarios finales viven en la instancia del workspace y son distintos.
</Aside>
