...
<CardGrid>
  <LinkCard
    title="Conectar Claude Desktop en 60 segundos"
    href="/agents/quickstart-claude/"
    description="npx @prysmid/mcp + dos líneas en claude_desktop_config.json. Listo."
  />
  <LinkCard
  ...
  <LinkCard
    title="Machine keys"
    href="/agents/machine-keys/"
    description="Service accounts con scopes para tu agente."
  />
  <LinkCard
    title="Safe defaults"
    href="/agents/safe-defaults/"
    description="Qué bloqueamos por default y cómo elevar permisos cuando es necesario."
  />
</CardGrid>
