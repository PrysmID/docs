...
| **Data** | `<slug>.auth.prysmid.com/*` | 50 req/seg por instance (burst 200) | Login flow: alto volumen. Configurable Pro+ si crecés. |
...
- **OIDC discovery** (`<slug>.auth.prysmid.com/.well-known/openid-configuration`).
- **JWKS** (`<slug>.auth.prysmid.com/oauth/v2/keys`) — Cloudflare lo cachea agresivamente.
