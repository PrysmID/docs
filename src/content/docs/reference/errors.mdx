...
| 502 | `upstream_error` | Algo upstream (Stripe, Zitadel, EmBoux, Cloudflare) falló. Reintentá con backoff. |
...
Estos los emite Zitadel directamente, no nosotros. Forma estándar OAuth 2:
