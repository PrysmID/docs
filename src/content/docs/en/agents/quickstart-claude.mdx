...
3. **Paste it into a fresh Claude Code session.**
   ...
   - Ask you to open a terminal and run `npx -y @prysmid/mcp` once to complete the **device flow** (URL + 8-character code in `XXXX-XXXX` format that you confirm in the browser)
