...
**Via dashboard**: `app.prysmid.com → settings → branding`. Upload PNG/SVG, pick two hex colors, preview, save. Changes live in the workspace's Zitadel instance and apply to the next session.
...
- No JavaScript (Zitadel blocks it for security).
- Max size: 64 KB.
