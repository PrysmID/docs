...
3. **Custom domain** — `auth.acme.com` instead of `your-slug.auth.prysmid.com`. Pro+.
...
| Custom CSS | ✅ Pro+ | ✅ Pro+ | — |
| Login URL | `<slug>.auth.prysmid.com` | same | `auth.<your-domain>` |
...
By default your instance lives at `<slug>.auth.prysmid.com`. If you want the login to appear under *your* domain (`auth.yourapp.com` or, for enterprise, `auth.acme.com`), follow this:
