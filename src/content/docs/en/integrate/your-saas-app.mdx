...
└── <your_slug>.auth.prysmid.com    (one instance)
...
2. Your BE: creates customer in *your* DB, creates tenant in Prysm:ID via API, returns link to `your_slug.auth.prysmid.com/...?tenant_hint=...`.
