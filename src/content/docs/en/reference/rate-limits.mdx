...
| **Data** | `<slug>.auth.prysmid.com/*` | 50 req/sec per instance (burst 200) | Login flow: high volume. Configurable on Pro+ if you grow. |
...
- **JWKS** (`<slug>.auth.prysmid.com/oauth/v2/keys`) — Cloudflare caches it aggressively.
