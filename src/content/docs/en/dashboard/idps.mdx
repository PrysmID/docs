...
3. **Authorized redirect URIs**: paste the callback the dashboard shows when you pick Google. Form: `https://<your-slug>.auth.prysmid.com/idps/callback`.
...
3. **Authorization callback URL**: `https://<your-slug>.auth.prysmid.com/idps/callback`.
...
2. Configure a **Sign in with Apple** Services ID. **Return URL** (Web): `https://<your-slug>.auth.prysmid.com/idps/callback`.
...
2. **ACS URL** (Assertion Consumer Service): `https://<your-slug>.auth.prysmid.com/saml/acs`.
3. **Entity ID**: `https://<your-slug>.auth.prysmid.com/saml/metadata`.
