...
└── <tu_slug>.auth.prysmid.com    (una sola instancia)
...
2. Tu BE: crea customer en *tu* DB, crea tenant en Prysm:ID via API, devuelve link a `tu_slug.auth.prysmid.com/...?tenant_hint=...`.
